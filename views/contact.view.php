...
<!-- steps -->
	...
	<h3 class="head">Contact</h3>
		<p class="urna">Kantor kami adalah rumah kami, namun jika ingin menjalin komunitas silahkan datang setelah jam kerja</p>
		<div class="inner_content">
			<div class="asked agile_info_shadow">
				<div class="contact">
					<h5>Address</h5>
					<p>Gondangan No.48 RT.002 RW.044 Sardonoharjo Ngaglik Sleman Yogyakarta</p>
				</div>
				<div class="contact">
					<h5>Email</h5>
					<p>web@langitinspirasi.co.id</p>
				</div>										
				<div class="contact">
